function Get-BasicADReport {
    ...
    # DCs grouped by AD Site
    $HTMLContent += "<h2>DCs grouped by AD Site</h2>"
    $HTMLContent += $MyDCs | Group-Object site | Sort-Object name | ConvertTo-HTML -Fragment -Property name,count
